...
<main>
    ...
    <!-- 행사 섹션 -->
    <section id="section-event" class="pt-[48px] lg:pt-[55px] px-5 mb-[96px] container mx-auto max-w-[1080px]">
    ...
    <section class="mb-[96px] last:mb-[64px] container mx-auto max-w-[1080px] px-5" id="event2-section">
        <div class="flex flex-col items-center mb-6 w-full">
            <tag:Tag label="Event 2" variant="event" />
            <title:Title 
    ...
    <section class="px-5 container mx-auto max-w-[1080px] mb-[64px]">
    ...
    <section class="lg:bg-[#F9FAFC] py-[64px]">
        <!-- 행사 브랜드 -->
        <c:if test="${brands != null and not empty brands}">
